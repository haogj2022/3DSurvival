...
public class AudioController : SingletonMonoBehaviour<AudioController>, ISerializationCallbackReceiver
{
	...
	public static List<AudioObject> GetPlayingAudioObjects(bool includePausedAudio = false, Predicate<AudioObject> predicate = null)
	{
		return null;
	}

	public static void InvokeForAllPlayingAudioObjects(Action<AudioObject> action, bool includePausedAudio = false)
	{
	}
